    ...
    def ScrapPdfData(self):
        ...
        for policy in cis_policies:
            ...
            if auditsoutput:
                ...
                audit_output = re.findall(r'is enable', audit_content) # retreive audit output "is enabled"
                if len(audit_output) == 0:
                    audit_output = re.findall(r'is not enabled', audit_content) # retreive audit output "is not enabled"
                if len(audit_output) == 0:
                ...
                if len(audit_output) == 0:
                    audit_output = re.findall(r'Access: (.+)', audit_content) # find the next word 
                if len(audit_output) != 0:
            ...
            if auditsscript:
                ...
                if len(audit_script) != 0:
                    ...
                    audit_script = re.sub(r'Page\s\d{1,3}', '', audit_script) #Delete "Page xxx"
                else:
                    audit_script = ""
            else:
                audit_script = ''
